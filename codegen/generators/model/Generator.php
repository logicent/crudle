...
namespace crudle\kit\generators\model;
...
class Generator extends \crudle\kit\Generator
{
    ...
    public $tableName;
    public $modelClass;
    public $baseModelClass = 'crudle\app\crud\models\BaseActiveRecord';
    ...
    public function hints()
    {
        ...
        return array_merge(parent::hints(), [
            ...
            'modelClass' => 
                ...
                <br>You do not need to specify the class name if "Table Name" ends with asterisk, in which case
                multiple ActiveRecord classes will be generated.',
            'standardizeCapitals' => 
                'This indicates whether the generated class names should have standardized capitals. 
                <br>For example, table names like <code>SOME_TABLE</code> or <code>Other_Table</code> 
            ...
            'generateRelations' => 
                ...
                foreign key constraints it detects in the database.
                <br>Note that if your database contains too many tables,
            ...
            'queryClass' => 
                'This is the name of the ActiveQuery class to be generated. The class name should not contain
                the namespace part as it is specified in "ActiveQuery Namespace".
                <br>You do not need to specify the class name if "Table Name" ends with asterisk, in which case
                multiple ActiveQuery classes will be generated.',
            'queryBaseClass' => 
