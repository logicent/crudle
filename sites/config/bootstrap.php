...
$configPath = $findConfigPath('--configPath', 'CRUDLE_CONFIG_PATH') ?? "$rootPath/sites/config";
$migrationsPath = $findConfigPath('--migrationsPath', 'CRUDLE_MIGRATIONS_PATH') ?? "$rootPath/sites/database/migrations";
$storagePath = $findConfigPath('--storagePath', 'CRUDLE_STORAGE_PATH') ?? "$rootPath/sites/storage";
