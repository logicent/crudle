...
use crudle\app\web_cms\models\AboutTeamMember;
...
<?= $this->render('@appMain/views/_form_section/item', [
        ...
        'form' => $form,
        'formView' => '@webCms/views/about_page/team_member/field_inputs',
        'listColumns' => '@webCms/views/about_page/team_member/list_columns',
        'listId' => 'team_member',
    ]) ?>
