...
<p class="text-muted">
    <?= Yii::t('app', 'Customize the label, hide on print, default value, etc ...') ?>
</p>
    <?= GridView::widget([
        'layout' => "{items}\n{pager}",
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function($model, $key, $index, $column){
                            return Html::tag('div',
                                        Html::activeDropDownList($model, "[$index]type", DocTypeField::getListOptions()  , ['data' => ['modal-input' => 'type']]),
                                    ['class' => 'ui transparent input']);
                        },
                'format' => 'raw'
            ],
