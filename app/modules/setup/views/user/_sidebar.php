...
<div class="ui vertical segment">
    <div class="ui vertical text menu">
        <a href="#<?= Url::to(['index', 'PersonSearch' => ['status' => User::STATUS_ACTIVE]]) ?>" class="item">
            <?= Yii::t('app', 'Active') ?>
        ...
        <a href="#<?= Url::to(['index', 'PersonSearch' => ['status' => User::STATUS_DELETED]]) ?>" class="item">
            <?= Yii::t('app', 'Deleted') ?>
...
<div id="sidebar">
    <?= $this->render('//_form/_sidebar_links') ?>
</div>
<?php
endif ?>