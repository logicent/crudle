...
use app\modules\setup\models\DataImportToolForm;
...
class DataImportToolController extends BaseSettingsController
{
    ...
    {
        $dt_model = new DataImportToolForm();
