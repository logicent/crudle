...
abstract class BaseController extends Controller
{
    ...
    public function actionChangeStatus($id)
    {
        ...
        if (Yii::$app->request->isAjax) {
            ...
            if ($model->save()) {
                ...
                $comment->comment = "Changed the $this->resourceName status from <b> $oldStatus </b> to <b> $model->status </b>";
            ...
            // else
            return $this->asJson(['failed' => true, 'errors' => $model->errors]);
        }
        Yii::$app->end();
    }
    ...
    {
        if (Yii::$app->request->isAjax); {
            return $this->renderAjax('/_form/_comment_modal', [
    ...
    public function actionSaveComment($model_id)
    {
        if (Yii::$app->request->isAjax); {
            ...
            return $this->renderPartial('/_layouts/_comments', ['comments' => $model->comments]);
        }
        // else
        Yii::$app->end();
    }
